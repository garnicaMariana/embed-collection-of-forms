...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ExpType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ExpType']) ? $this->services['AppBundle\Form\ExpType'] : $this->services['AppBundle\Form\ExpType'] = new \AppBundle\Form\ExpType()) && false ?: '_'};

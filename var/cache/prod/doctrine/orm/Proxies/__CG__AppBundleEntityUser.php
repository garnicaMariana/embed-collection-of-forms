...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'fullname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'exp'];
        }
    ...
    public function addExp(\AppBundle\Entity\Exp $exp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addExp', [$exp]);

        return parent::addExp($exp);
    }
    ...
    public function removeExp(\AppBundle\Entity\Exp $exp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeExp', [$exp]);

        return parent::removeExp($exp);
    }
